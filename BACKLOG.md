...
- [x] autocorrelation — measuring how a time series correlates with a lagged copy of itself, and reading the resulting correlogram, built from correlation
- [x] bonferroni-correction — adjusting significance thresholds when running many hypothesis tests at once so false positives don't pile up, built from p-value
